  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6">
      <div className="w-full max-w-7xl ">
        <h1 className="text-4xl font-bold mb-4 text-center">Live Video Moderation System</h1>
        <p className="text-xl mb-8 text-center text-muted-foreground">Real-time content analysis and moderation for live camera feed</p>
